...
const SuperpositionSimulator = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-slate-50 rounded-xl shadow-xl font-sans text-slate-800">
            ...
            <div className="relative h-64 bg-white rounded-xl border border-slate-300 shadow-inner mb-8 select-none overflow-auto">
                <div className="relative min-w-[850px] h-full">
